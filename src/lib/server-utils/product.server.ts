...
import {SHOPPABLE_SOCIAL_VIDEO_SECTION_KEY} from '~/sections/ShoppableSocialVideo/ShoppableSocialVideo.schema';
import {PRODUCT_SECTION_KEY} from '~/sections/Product/Product.schema';
