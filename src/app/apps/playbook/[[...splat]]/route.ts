...
export const HEAD = routeHandler(loader);
export const POST = routeHandler(action);
export const PUT = routeHandler(action);
export const PATCH = routeHandler(action);
export const DELETE = routeHandler(action);
export const OPTIONS = routeHandler(action);
